...
<%@ page import="com.urise.webapp.model.ExperienceSection" %>
...
<section>
  <form method="post" action="resume" enctype="application/x-www-form-urlencoded">
    ...
    <h1>Имя:</h1>
    <dl>
      <input type="text" name="fullName" pattern="[а-я,А-Я, ]{1,35}" title="Введите имя на кириллице с большой быквы" size=55 value="${resume.fullName}">
    </dl>
    <h2>Контакты:</h2>
    ...
    <c:forEach var="type" items="<%=SectionType.values()%>">
      ...
      <c:choose>
        ...
        <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
          <c:forEach var="org" items="<%=((ExperienceSection) section).getOrganizations()%>"
                     varStatus="counter">
            <dl>
            ...
            <div style="margin-left: 30px">
              <c:forEach var="pos" items="${org.institutionPeriod}">
