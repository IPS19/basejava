...
public class ResumeTestData {
    ...
    public static Resume createResume (String uuid, String fullName){
        ...
        Experience school = new Experience("Заочная физико-техническая школа при МФТИ",
                new Experience.PeriodInInstitution(YearMonth.of(1987, 9), YearMonth.of(1993, 7), "Закончил с отличием"));

        Experience itmo = new Experience("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики",
                new Experience.PeriodInInstitution(YearMonth.of(1987, 9), YearMonth.of(1993, 7), "Инженер (программист Fortran, C)"));
        itmo.addInstitution(new Experience.PeriodInInstitution(YearMonth.of(1993, 9), YearMonth.of(1996, 7), "Аспирантура (программист С, С++)"));

        Experience alcatelEdu = new Experience("Alcatel",
                new Experience.PeriodInInstitution(YearMonth.of(1997, 9), YearMonth.of(1998, 3),"6 месяцев обучения цифровым телефонным сетям (Москва)"));

        Experience simensEdu = new Experience("Siemens AG",
                new Experience.PeriodInInstitution(YearMonth.of(2005, 1), YearMonth.of(2005, 4), "3 месяца обучения мобильным IN сетям (Берлин)"));

        Experience luxoftEdu = new Experience("Luxoft",
                new Experience.PeriodInInstitution(YearMonth.of(2011, 3), YearMonth.of(2011, 4), "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.'"));

        Experience coursera = new Experience("Coursera",
                new Experience.PeriodInInstitution(YearMonth.of(2013, 3), YearMonth.of(2013, 5), "'Functional Programming Principles in Scala' by Martin Odersky"));
        ...
        Experience alcatel = new Experience("Alcatel",
                new Experience.PeriodInInstitution(YearMonth.of(1997, 9), YearMonth.of(2005, 1),
        ...
        Experience simens = new Experience("Siemens AG",
                new Experience.PeriodInInstitution(YearMonth.of(2005, 1), YearMonth.of(2007, 2), "Разработчик ПО", "Разработка информационной модели, проектирование интерфейсов, реализация и отладка ПО на мобильной IN платформе Siemens @vantage (Java, Unix)."));

        Experience enkata = new Experience("Enkata",
                new Experience.PeriodInInstitution(YearMonth.of(2007, 3), YearMonth.of(2008, 6),
        ...
        Experience yota = new Experience("Yota",
                new Experience.PeriodInInstitution(YearMonth.of(2008, 6), YearMonth.of(2010, 12),
        ...
        Experience luxoft = new Experience("Luxoft (Deutsche Bank)",
                new Experience.PeriodInInstitution(YearMonth.of(2010, 12), YearMonth.of(2012, 4), "Ведущий программист", "Участие в проекте Deutsche Bank CRM (WebLogic, Hibernate, Spring, " +
        ...
        Experience rit = new Experience("RIT Center",
                new Experience.PeriodInInstitution(YearMonth.of(2012, 4), YearMonth.of(2014, 10),
        ...
        Experience wrike = new Experience("Wrike",
                new Experience.PeriodInInstitution(YearMonth.of(2014, 10), YearMonth.of(2016, 1),
        ...
        Experience jop = new Experience("Java Online Projects",
                new Experience.PeriodInInstitution(YearMonth.of(2013, 10), YearMonth.now(),  "Автор проекта.",
